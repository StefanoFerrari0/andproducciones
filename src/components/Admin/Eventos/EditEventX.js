...
export default class EditEventArtist extends Component {
    ...
    componentDidMount() {
        ...
        const ref = db.collection("Eventos").doc(this.props.match.params.id);
        ref.get().then((doc) => {
            if (doc.exists) {
    ...
    onSubmit = (e) => {
        ...
        const updateRef = db.collection('Eventos').doc(this.state.key);
                        ...
                        <form className="center-block" onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                {this.state.allArtist.length === 0 ?
                                    this.GetArtistas() : null
                                }

                                <div className="container" style={{ width: "1200px", display: "block" }} >
                                    <table className="table table-responsive table-hover table-dark" style={{ width: "300px", float: "left" }}>
                                        <thead>
                                            <tr>
                                    ...
                                    {this.state.allArtist.length === 0 ?
                                        null : <table className="table table-responsive table-hover table-dark" style={{ height: "fit-content", width: "300px", float: "left" }}>
                                            <thead>
                                                <tr>
